...
Route::get('/about-author','HomeController@about')->name('about_author');
Route::get('/my-book','HomeController@myBook')->name('my_book');
Route::get('/reviews','HomeController@reviews')->name('reviews');
Route::post('/review', 'HomeController@storeReview')->name('store_review');
